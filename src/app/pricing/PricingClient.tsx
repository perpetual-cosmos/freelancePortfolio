...
import { HelpCircle, ChevronDown, ArrowRight, Star } from 'lucide-react';
...
const faqs = [
  ...
  },
  {
    ...
    a: "Yes. We've delivered products used globally across 70+ countries. Communication is in English, and we align to your timezone for standups."
  }
];
    ...
    <main className="bg-background">
      ...
      <section className="pt-28 sm:pt-32 lg:pt-36 pb-8 sm:pb-10 lg:pb-12 text-center relative overflow-hidden">
        ...
        <div className="max-w-[600px] mx-auto px-4 sm:px-8 relative z-10">
          ...
          >
            Fixed-fee engineering packages built for predictability. No hidden costs, no vendor lock-in.
          </motion.p>
        </div>
      </section>
      ...
      <section className="py-14 sm:py-20 lg:py-24">
        <div className="max-w-[700px] mx-auto px-4 sm:px-8">
          <div className="text-center mb-8 sm:mb-10">
            ...
            <p className="text-on-surface-muted text-[0.82rem] sm:text-[0.88rem] font-medium">Everything you need to know about working with Tarun Singh & TheUniPick.</p>
          </div>
