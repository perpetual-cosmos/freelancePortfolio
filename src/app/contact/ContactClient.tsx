      ...
      <section style={{ 
        ...
        <div style={{ maxWidth: '800px', margin: '0 auto', padding: '0 2rem' }}>
          ...
          <p style={{ fontSize: '1.25rem', color: 'var(--on-surface-variant)', lineHeight: 1.6 }}>
            Whether you're scoping a new project or looking to modernize your existing stack, speak directly with Tarun Singh & team.
          </p>
        </div>
      </section>
        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          <div style={{ 
            ...
            <div className="card-premium" style={{ padding: '3rem', background: 'white', textAlign: 'center' }}>
              ...
              <p style={{ color: 'var(--on-surface-variant)', fontSize: '1rem', lineHeight: 1.6 }}>We typically respond to project inquiries within 12-24 business hours.</p>
            </div>
            ...
            <div className="card-premium" style={{ padding: '3rem', background: 'white', textAlign: 'center' }}>
              ...
              <h3 style={{ fontSize: '1.4rem', marginBottom: '1rem', fontWeight: 800 }}>Global Availability</h3>
              <p style={{ color: 'var(--on-surface-variant)', fontSize: '1rem', lineHeight: 1.6 }}>Serving clients across India, US, UK, and Europe with flexible timezone standups.</p>
            </div>
            ...
            <div className="card-premium" style={{ padding: '3rem', background: 'white', textAlign: 'center' }}>
              ...
              <p style={{ color: 'var(--on-surface-variant)', fontSize: '1rem', lineHeight: 1.6 }}>No sales middlemen. You'll discuss architecture directly with Tarun Singh.</p>
            </div>
          </div>
        </div>
      </section>
