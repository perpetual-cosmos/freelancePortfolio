    ...
    <main className="bg-[#050505] min-h-screen">
      ...
      <section className="relative pt-28 sm:pt-32 lg:pt-36 pb-8 sm:pb-10 lg:pb-12 overflow-hidden border-b border-white/5">
        ...
        <div className="max-w-[1400px] mx-auto px-4 sm:px-8 lg:px-14 relative z-10 text-center">
          ...
          >
            Mission-critical web applications, Shopify stores, and AI systems built by Tarun Singh & studio.
          </motion.p>
        </div>
      </section>
            ...
            {additionalProjects.map((p, i) => (
              ...
              >
                ...
                <div className="relative aspect-video overflow-hidden bg-[#0a0a0a]">
                   <img src={p.image} alt={`${p.title} portfolio item by TheUniPick`} className="absolute inset-0 w-full h-full object-cover opacity-85 group-hover:scale-105 group-hover:opacity-100 transition-all duration-700" />
                ...
                <div className="flex-1 p-4 sm:p-5 space-y-2">
                  ...
                  <div className="pt-2 flex flex-wrap items-center gap-2">
                    ...
                    <a href={p.link} target="_blank" rel="noopener noreferrer" className="flex items-center gap-1 text-[0.68rem] font-bold text-on-surface-muted hover:text-primary transition-colors no-underline">
          ...
          >
             ...
             <div className="flex-1 text-center sm:text-left">
                ...
                <p className="text-white/50 text-[0.78rem] sm:text-[0.82rem] font-medium">
                   Let's discuss how Tarun & TheUniPick can build your next competitive advantage.
                </p>
             </div>
