...
import { ArrowRight, Check, ChevronDown, ArrowLeft, Sparkles, ExternalLink } from 'lucide-react';
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1.3fr,0.7fr] gap-6 sm:gap-8">
            ...
            <div className="space-y-4">
              ...
              <div className="bg-primary/5 border border-primary/10 rounded-xl p-4 sm:p-5">
                ...
                <p className="text-on-surface font-bold text-[0.82rem] sm:text-[0.88rem] leading-relaxed italic mb-3">"{service.outcome}"</p>
                {service.relatedCaseStudySlug && (
                  <Link
                    href={`/case-study/${service.relatedCaseStudySlug}`}
                    className="inline-flex items-center gap-1.5 text-[0.72rem] font-bold text-primary hover:underline"
                  >
              ...
              <div className="bg-white border border-[rgba(0,0,0,0.05)] rounded-xl p-4 sm:p-5">
                ...
                <p className="text-[0.78rem] text-on-surface-muted font-medium mb-4">
                  Let's discuss how Tarun & TheUniPick can accelerate your business.
                </p>
              ...
              <Link href="/audit" className="flex items-center justify-center gap-2 w-full py-2.5 rounded-xl border border-primary/15 text-primary font-bold text-[0.78rem] no-underline hover:bg-primary/5 transition-all">
                Or get a free website audit first <ArrowRight size={13} />
              </Link>
            </div>
          </div>
        </div>
