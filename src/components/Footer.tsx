  ...
  return (
    <footer style={{ padding: '10rem 2rem 5rem', background: '#ffffff', borderTop: '1px solid var(--outline-variant)' }}>
      <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
        <div style={{ display: 'grid', gridTemplateColumns: '2.5fr 1fr 1fr 2fr', gap: '8rem', marginBottom: '8rem' }} className="footer-grid">
          ...
          <div>
            ...
            <p style={{ color: 'var(--on-surface-variant)', fontSize: '1rem', lineHeight: 1.8, marginBottom: '3rem', maxWidth: '380px' }}>
